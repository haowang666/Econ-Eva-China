...
*These questions range from disagree at all to strongly agree
*Changed scale to reflect levels of critical thinking
gen obey =.
replace obey =1 if qe4711 ==4
replace obey =2 if qe4711 ==3
replace obey =3 if qe4711 ==2
replace obey =4 if qe4711 ==1
...
*qe4734 only experts can influence the policy making
gen expert =. 
replace expert =1 if qe4734 == 4
replace expert =2 if qe4734 == 3
replace expert =3 if qe4734 == 2
replace expert =4 if qe4734 == 1

*qe4735 对本地政策有意见有权向上级申诉
* citizens can voice theri opinions of local government to the upper level government
gen voice_upper =. 
replace voice_upper =1 if qe4735 == 1
replace voice_upper =2 if qe4735 == 2
replace voice_upper =3 if qe4735 == 3
replace voice_upper =4 if qe4735 == 4


*This may not be useful*****************************
*laws can be effective only if gov is supporting qe4712
gen law_gov =.
replace law_gov =1 if qe4712 ==4
replace law_gov =2 if qe4712 ==3
replace law_gov =3 if qe4712 ==2
replace law_gov =4 if qe4712 ==1
